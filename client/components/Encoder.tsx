...
export const Encoder = () => {
  ...
  return (
    <div id="Encoder" className="mt-7 flex flex-col items-center justify-center mx-auto bg-white shadow-xl border rounded-md p-6 w-full max-w-sm sm:max-w-md md:max-w-lg">
